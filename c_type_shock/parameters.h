...
// the ionization reactions H2,He + CR_particle lead to gas ionization rate zeta = 1.346e-17 s-1, zeta*n_H2 equals to production of electrons in unit volume, 
...
#define STANDARD_CR_IONIZ_RATE 1.36e-17  // s-1 per H2
...
// our estimate of iron flux for CR ionization rate 1.36e-17 s-1 and for Fe/H = 1.6e-4:
...
// is applied to reactions with one and multiple products,
...
// Jin & Garrod, ApJS (2020), suggested that photodissociation rates in ice are lower by factor 3 (but they refer to paper by Kalvans, 2018)
#define ICE_PHOTODISS_EFFICIENCY 0.15  // estimate
